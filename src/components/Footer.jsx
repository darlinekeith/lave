  ...
  return (
    <div className='w-full mt-24  bg-slate-900 text-gray-300 py-3 px-1'>
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 border-b-2 border-gray-600 py-8'>
            ...
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="http:darlinekeith.github.com/lave" class="hover:underline">LAVE™</a>. All Rights Reserved.
            </span>
            </div>
